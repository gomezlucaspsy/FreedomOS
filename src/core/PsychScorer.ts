...
const COUNTRY_RIASEC_AFFINITY: Record<string, RIASECScores> = {
  ...
  'Chipre':          { E: 75, C: 75, S: 65, I: 60, A: 55, R: 45 },
  'Croacia':         { S: 75, R: 65, E: 65, A: 60, C: 60, I: 55 },
  'Estonia':         { I: 90, E: 75, C: 70, R: 60, A: 60, S: 50 },
  'Georgia':         { E: 75, A: 70, S: 65, I: 60, R: 55, C: 50 },
  'Grecia':          { S: 80, A: 70, E: 65, R: 55, C: 55, I: 55 },
  'Hungría':         { R: 75, I: 70, C: 75, E: 55, S: 55, A: 50 },
  'Luxemburgo':      { C: 90, E: 80, I: 75, S: 60, R: 50, A: 45 },
  'Malta':           { E: 75, C: 75, S: 70, I: 65, A: 55, R: 45 },
  'Rumanía':         { I: 80, R: 70, C: 70, E: 55, S: 50, A: 50 },
  // ── Americas ────────────────────────────────────────────
  ...
  'Costa Rica':      { S: 75, I: 70, C: 65, E: 65, A: 60, R: 55 },
  'Panamá':          { E: 80, C: 75, S: 70, I: 55, R: 55, A: 50 },
  'Paraguay':        { R: 75, E: 65, C: 60, S: 60, I: 50, A: 50 },
  'Perú':            { R: 70, E: 70, S: 65, I: 60, C: 60, A: 55 },
  // ── Asia-Pacific ────────────────────────────────────────
  ...
  'Malasia':         { R: 70, I: 75, C: 75, E: 65, S: 55, A: 50 },
  'Tailandia':       { S: 80, A: 70, E: 65, R: 55, C: 55, I: 50 },
  // ── Middle East ─────────────────────────────────────────
