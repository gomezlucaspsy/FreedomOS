...
const SKILL_LEARNING_META: Record<string, Omit<SkillRecommendation, 'skill'>> = {
  ...
  // Visa-ready / ticket skills
  'White Card':                     { priority: 'alta',    learningWeeks: 1, platforms: ['RTO Australia', 'TAFE', 'Centros certificados'],          reason: 'Ticket base de seguridad para obras y muchos roles FIFO en Australia.' },
  'Working at Heights':             { priority: 'alta',    learningWeeks: 1, platforms: ['RTO Australia', 'TAFE', 'Cursos HSE'],                    reason: 'Certificación exigida en mineria, energia y mantenimiento industrial.' },
  'Confined Space Entry':           { priority: 'alta',    learningWeeks: 1, platforms: ['RTO Australia', 'Cursos HSE', 'Centros certificados'],     reason: 'Requisito frecuente en mantenimiento industrial y operaciones FIFO.' },
  'First Aid/CPR':                  { priority: 'alta',    learningWeeks: 1, platforms: ['St John', 'Cruz Roja', 'RTO Australia'],                  reason: 'Certificación transversal para hospitality, cuidados y sectores industriales.' },
  'RSA (Responsible Service of Alcohol)': { priority: 'media', learningWeeks: 1, platforms: ['RSA Online', 'RTO Australia', 'TAFE'],               reason: 'Requisito habitual para bar, hoteleria y eventos en Australia/NZ.' },
  'RSG (Responsible Service of Gambling)': { priority: 'media', learningWeeks: 1, platforms: ['RSG Online', 'RTO Australia', 'TAFE'],              reason: 'Habilita roles en venues y hospitality con gaming autorizado.' },
  'Manual Handling':                { priority: 'media',   learningWeeks: 1, platforms: ['Centros de empleo', 'RTO Australia', 'Sindicatos'],       reason: 'Competencia clave para warehouse, limpieza, construccion y trabajo estacional.' },
  // ── Entry-level / Oficios ────────────────────────────────────────────────
...
const COUNTRY_CRITICAL_SKILLS: Record<string, string[]> = {
  ...
  'España':          ['React', 'JavaScript', 'SQL', 'Inglés', 'Excel', 'Cocina profesional', 'Atención al cliente', 'Logística de almacén', 'Agricultura y campo', 'Limpieza profesional', 'Albañilería', 'Manipulación de alimentos', 'Manual Handling'],
  ...
  'Irlanda':         ['TypeScript', 'React', 'Node.js', 'Docker', 'AWS', 'Inglés', 'Cocina profesional', 'Atención al cliente', 'Cuidado de personas mayores', 'Manual Handling', 'Manipulación de alimentos'],
  ...
  'Chipre':          ['Finanzas', 'Contabilidad', 'SQL', 'Inglés', 'Python', 'Turismo', 'Cocina profesional', 'Atención al cliente'],
  'Croacia':         ['Inglés', 'Turismo', 'Cocina profesional', 'Atención al cliente', 'Albañilería', 'Java', 'SQL', 'Conducción profesional'],
  'Estonia':         ['TypeScript', 'React', 'Python', 'Docker', 'Inglés', 'SQL', 'Git', 'Kubernetes'],
  'Georgia':         ['React', 'Python', 'SQL', 'Inglés', 'Turismo', 'Marketing', 'Atención al cliente'],
  'Grecia':          ['Inglés', 'Turismo', 'Cocina profesional', 'Atención al cliente', 'Agricultura y campo', 'Python', 'SQL', 'Logística de almacén'],
  'Hungría':         ['Java', 'SQL', 'Python', 'Inglés', 'Manufactura', 'Logística de almacén', 'Conducción profesional', 'Excel'],
  'Luxemburgo':      ['Finanzas', 'Contabilidad', 'SQL', 'Francés', 'Alemán', 'Inglés', 'Python', 'Power BI', 'Enfermería', 'Albañilería'],
  'Malta':           ['Inglés', 'SQL', 'Python', 'Finanzas', 'Contabilidad', 'Cocina profesional', 'Turismo', 'Atención al cliente', 'Cuidado de personas mayores'],
  'Rumanía':         ['Java', 'Python', 'SQL', 'C#', 'Inglés', 'Manufactura', 'Albañilería', 'Conducción profesional'],
  // ── Americas ──────────────────────────────────────
  ...
  'Canadá':          ['Python', 'Machine Learning', 'React', 'SQL', 'AWS', 'Inglés', 'Cuidado de personas mayores', 'Conducción profesional', 'Logística de almacén', 'Albañilería', 'First Aid/CPR', 'Manual Handling'],
  ...
  'Costa Rica':      ['Inglés', 'Python', 'SQL', 'Java', 'Atención al cliente', 'Turismo', 'Contabilidad', 'Excel'],
  'Panamá':          ['Inglés', 'Logística', 'Finanzas', 'Contabilidad', 'SQL', 'Atención al cliente', 'Logística de almacén', 'Turismo'],
  'Paraguay':        ['Agricultura y campo', 'Logística de almacén', 'Contabilidad', 'SQL', 'Atención al cliente', 'Conducción profesional', 'Excel'],
  'Perú':            ['SQL', 'Python', 'Inglés', 'Ingeniería', 'Contabilidad', 'Atención al cliente', 'Agricultura y campo', 'Logística de almacén'],
  // ── Asia-Pacific ──────────────────────────────────
  'Australia':       ['Python', 'SQL', 'AWS', 'React', 'Inglés', 'Agricultura y campo', 'Cuidado de personas mayores', 'Albañilería', 'Conducción profesional', 'White Card', 'Working at Heights', 'Confined Space Entry', 'First Aid/CPR', 'RSA (Responsible Service of Alcohol)', 'RSG (Responsible Service of Gambling)', 'Manual Handling'],
  ...
  'Nueva Zelanda':   ['Python', 'SQL', 'React', 'Inglés', 'Git', 'Agricultura y campo', 'Cuidado de personas mayores', 'Albañilería', 'RSA (Responsible Service of Alcohol)', 'First Aid/CPR', 'Manual Handling'],
  ...
  'Malasia':         ['Inglés', 'Python', 'SQL', 'Java', 'Manufactura', 'Logística de almacén', 'Atención al cliente', 'Excel'],
  'Tailandia':       ['Inglés', 'Turismo', 'Cocina profesional', 'Atención al cliente', 'Marketing', 'React', 'Python'],
  // ── Middle East ───────────────────────────────────
